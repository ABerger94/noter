    ...
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
      <div>
        ...
        <input
          ...
          placeholder="e.g. Week 4 - Bayesian Inference"
      ...
      <div>
        ...
        <textarea
          ...
          placeholder={"Write your notes here...\n\n## Headings, **bold**, - lists and more are supported."}
          className="w-full rounded-lg border border-slate-300 px-3 py-2 font-mono text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
        />
      </div>
